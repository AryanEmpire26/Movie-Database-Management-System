...
public:
    Movie(string title, string releaseDate, string synopsis, string rating)
    {
        this->title = title;
...
public:
    ...
    vector<Movie> skeyword(string &keyword)
    {
    ...
    bool isMovieExists(string movieTitle)
    {
        for (Movie movie : movies)
        {
            if (movie.getTitle() == movieTitle)
...
int main()
{
    ...
    cout << "    "
         << "===========================================" << endl;
    cout << "    "
         << "|| Welcome to the Movie Database Program ||" << endl;
    cout << "    "
         << "===========================================" << endl;
    cout << endl;
    vector<Movie> matchingMovies;
    while (true)
    {
        ...
        case 3:
            ...
            cin >> keyword;
            matchingMovies = movieDb.skeyword(keyword);
